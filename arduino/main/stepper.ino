...
void MoveToPosition(float posX, float posY, float stepperSpeed){
  ...
  int stepperL_vel = abs(thetaL(velX,velY,true));
  int stepperR_vel = abs(thetaR(velX,velY,true));
...
void MovePosition(float x_dist, float y_dist, float stepperSpeed){ 
  float dist = sqrt(sq(x_dist) + sq(y_dist));
  float velX = x_dist/dist * stepperSpeed;
  float velY = y_dist/dist * stepperSpeed;
  int stepperL_vel = abs(thetaL(velX,velY,true));
...
void setVelocity(float velX, float velY){
  ...
  stepperL->setSpeedInHz(stepperL_vel); 
  stepperR->setSpeedInHz(stepperR_vel);
  //Serial.println("velx:"+ String(velX) + " Vely:" + String(velY) +" ja:" + String(thetaL(velX,velY,true)));
  //Serial.println("velx:"+ String(velX) + " Vely:" + String(velY) +" ja:" + String(thetaR(velX,velY,true)));
}
